...
shared_examples 'a page that shows the missions sort by desc' do
  it 'shows the mission' do
    is_expected.to have_selector('tbody > tr:nth-child(1)', text: third_mission.title)
    is_expected.to have_selector('tbody > tr:nth-child(2)', text: second_mission.title)
    is_expected.to have_selector('tbody > tr:nth-child(3)', text: first_mission.title)
  end
end

shared_examples 'a page that shows the missions sort by asc' do
  it 'shows the mission' do
    is_expected.to have_selector('tbody > tr:nth-child(1)', text: first_mission.title)
    is_expected.to have_selector('tbody > tr:nth-child(2)', text: second_mission.title)
    is_expected.to have_selector('tbody > tr:nth-child(3)', text: third_mission.title)
  end
end

shared_examples 'a page that shows only pending missions' do
  it 'shows the mission' do
    is_expected.to have_selector('tbody > tr', text: Mission.human_enum_name(:statuses, :pending))
    is_expected.to have_no_selector('tbody > tr', text: Mission.human_enum_name(:statuses, :processing))
    is_expected.to have_no_selector('tbody > tr', text: Mission.human_enum_name(:statuses, :completed))
  end
end

shared_examples 'a page that shows only processing missions' do
  it 'shows the mission' do
    is_expected.to have_no_selector('tbody > tr', text: Mission.human_enum_name(:statuses, :pending))
    is_expected.to have_selector('tbody > tr', text: Mission.human_enum_name(:statuses, :processing))
    is_expected.to have_no_selector('tbody > tr', text: Mission.human_enum_name(:statuses, :completed))
  end
end
...
shared_examples 'a page that shows only completed missions' do
  it 'shows the mission' do
    is_expected.to have_no_selector('tbody > tr', text: Mission.human_enum_name(:statuses, :pending))
    is_expected.to have_no_selector('tbody > tr', text: Mission.human_enum_name(:statuses, :processing))
    is_expected.to have_selector('tbody > tr', text: Mission.human_enum_name(:statuses, :completed))
  end
end
